...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        # data parameters
        parser.add_argument('--dataset_name', type=str, default='set', help="Dataset name")
        parser.add_argument('--videos_dir', type=str, default="/root/Video-LLaVA/eval/GPT_Zero_Shot_QA/MSRVTT_Zero_Shot_QA/videos/all/", help="Location of videos")
        parser.add_argument('--videos_json', type=str, default='/root/Video-LLaVA/eval/GPT_Zero_Shot_QA/MSRVTT_Zero_Shot_QA/test_q.json', help="Location of videos")
        parser.add_argument('--videos_num_read', type=int, default=10) #
        parser.add_argument('--videos_start', type=int, default=0) 
        parser.add_argument('--videos_end', type=int, default=15) 
        ...
        parser.add_argument('--output_dir', type=str, default='/root/KeyVideoLLM/output')  #sort+q+a
        ...
        parser.add_argument('--arch', type=str, default='clip_extract')
        ...
        parser.add_argument('--extract_type', type=str, default='topk')
        parser.add_argument('--k', type=int, default=8, help='K value for topk extraction')
