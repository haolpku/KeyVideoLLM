...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument('--videos_json', type=str, default='/data/wentao/lijp_data/video_llava_data/train_data/train_json/videochatgpt_tune_.json', help="Location of videos")
        ...
        parser.add_argument('--output_dir', type=str, default='./outputs/keyframe_clip_videos_sort/videochatgpt_tune_qa/')  #sort+q+a
