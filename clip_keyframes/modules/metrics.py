...
def sim_matrix_training(text_embeds, vid_embeds_pooled, extract_type):
    """
...
def sim_matrix_inference(text_embeds_per_video_id, vid_embeds_pooled_per_video_id, extract_type):
    """
...
def generate_embeds_per_video_id(text_embeds, vid_embeds_pooled, all_vid_ids, extract_type):
